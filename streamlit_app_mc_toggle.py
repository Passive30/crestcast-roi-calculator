...
# Set benchmark return and volatility
if benchmark_choice == "MSCI USA Multi-Factor":
    benchmark_return = 0.0968
    benchmark_std_dev = 0.1632
else:  # S&P 500
    benchmark_return = 0.1153
    benchmark_std_dev = 0.1582
...
if run_sim:
    ...
    # Returns and risk assumptions for CrestCast
